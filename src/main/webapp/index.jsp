    ...
    <div class="carousel slide bestSellers-size-slide" data-ride="carousel" id="carousel-1">
        <div class="carousel-inner bestSellers-size-inner" role="listbox">
            <div class="carousel-item bestSellers-size-item active">
                <a href="/GameDataSheet?gameId=${firstGameBestSeller.get(0)}"><img class="d-block bestSellers-size-img" src=""></a><!--TODO:front image-->
            </div>
            <div class="carousel-item bestSellers-size-item">
                <a href="/GameDataSheet?gameId=${secondGameBestSellers.get(0)}"><img class="d-block bestSellers-size-img " src=""></a><!--TODO:front image-->
            </div>
            <div class="carousel-item bestSellers-size-item">
                <a href="/GameDataSheet?gameId=${thirdGameBestSellers.get(0)}"><img class="d-block bestSellers-size-img " src=""></a><!--TODO:front image-->
            </div>
            <div>
